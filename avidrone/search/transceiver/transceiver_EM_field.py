...
#   TODO Create a unique plot for combined EM field
...
coil_2 = magpy.current.Line(current=750, vertices=vertices_2)
...
ax2.set(
    title="Magnetic field of a two-antenna transceiver",
    xlabel="x-position [mm]",
    ylabel="z-position [mm]",
    aspect=1,
)
