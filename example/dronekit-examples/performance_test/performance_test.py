...
parser = argparse.ArgumentParser(
    description="Generates max, min and current interval between message sent and ack received. Will start and connect to SITL if no connection string specified."
)
parser.add_argument(
    "--connect",
...
class MeasureTime(object):
    ...
    def log(self):
        ...
        sys.stdout.write(
            "MaxInterval: %s\tMinInterval: %s\tInterval: %s\r"
