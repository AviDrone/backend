...
parser = argparse.ArgumentParser(
    description="Creates a CherryPy based web application that displays a mapbox map to let you view the current vehicle position and send the vehicle commands to fly to a particular latitude and longitude. Will start and connect to SITL if no connection string specified."
)
parser.add_argument(
    "--connect",
...
cherrypy_conf = {
    "/": {"tools.sessions.on": True, "tools.staticdir.root": local_path},
    "/static": {"tools.staticdir.on": True, "tools.staticdir.dir": "./html/assets"},
}
...
class Drone(object):
    ...
    def _run_server(self):
        ...
        print(
            """Server is bound on all addresses, port 8080
